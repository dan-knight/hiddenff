...
const totalRushYdPerAtt = { name: 'total_rush_yd_per_att', label: 'Rush Yd / Att', sortable: true };
...
const totalRecYdPerRec = { name: 'total_rec_yd_per_rec', label: 'Rec Yd / Rec', sortable: true };
...
const totalPassYdPerCmp = { name: 'total_pass_yd_per_cmp', label: 'Pass Yd / Cmp', sortable: true };
